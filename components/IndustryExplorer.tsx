...
const INDUSTRIES: Industry[] = [
  {
    ...
    tags: ["Concierge agents", "Dynamic pricing", "Itinerary planners", "Review analysis"],
    outcomes: ["Answer guests instantly, in any language", "Fill more rooms with demand-based pricing", "Plan trips tailored to each traveller"],
  ...
  },
  {
    ...
    tags: ["Document intelligence", "Site progress vision", "Lead qualifiers", "Valuation models"],
    outcomes: ["Read contracts and plans in seconds", "Track site progress from camera feeds", "Score and prioritise every lead"],
  ...
  },
  {
    ...
    tags: ["Predictive maintenance", "Compliance search", "Ops copilots", "Anomaly detection"],
    outcomes: ["Catch faults before they ground fleets", "Find any regulation in one question", "Cut unplanned downtime"],
  ...
  },
  {
    ...
    tags: ["Fraud detection", "KYC automation", "Support agents", "AML monitoring"],
    outcomes: ["Flag fraud in real time, before money leaves", "Verify new customers in minutes", "Answer customers without a queue"],
  ...
  },
  {
    ...
    tags: ["Recommendation engines", "Demand forecasting", "Catalog automation", "Visual search"],
    outcomes: ["Lift baskets with personal recommendations", "Forecast stock to avoid sell-outs", "Keep the catalogue clean automatically"],
  ...
  },
  {
    ...
    tags: ["Adaptive tutors", "Grading assistants", "Course generation", "Progress analytics"],
    outcomes: ["Give every learner a personal tutor", "Grade and prep lessons in the background", "Free teachers to teach"],
  ...
  },
  {
    ...
    tags: ["Credit scoring", "Reconciliation agents", "Risk models", "Transaction insights"],
    outcomes: ["Decide credit in seconds, with reasons", "Reconcile accounts automatically", "Model risk continuously"],
  ...
  },
  {
    ...
    tags: ["Claims triage", "Underwriting copilots", "Policy search", "Fraud checks"],
    outcomes: ["Settle simple claims automatically", "Price risk on real data", "Answer policy questions instantly"],
  ...
  },
  {
    ...
    tags: ["Content generation", "Audience targeting", "Creative testing", "Performance analytics"],
    outcomes: ["Generate creative in minutes, not weeks", "Match audiences to the right message", "Double down on what works"],
  ...
  },
  {
    ...
    tags: ["Robotics perception", "Vision QA", "Autonomy stacks", "Edge inference"],
    outcomes: ["See and act in the real world", "Inspect quality at line speed", "Navigate spaces safely"],
  ...
  },
  {
    ...
    tags: ["Clinical documentation", "Triage agents", "Records search", "Prior-auth automation"],
    outcomes: ["Write clinical notes automatically", "Triage patients to the right care", "Find any record in one question"],
  ...
  },
  {
    ...
    tags: ["Support automation", "Voice agents", "Smart routing", "Sentiment analysis"],
    outcomes: ["Answer across chat, email, and voice", "Resolve common requests automatically", "Route the hard ones instantly"],
  ...
  },
  {
    ...
    tags: ["In-car assistants", "Diagnostics AI", "Fleet intelligence", "ADAS vision"],
    outcomes: ["Give drivers a natural assistant", "Diagnose faults early", "Optimise fleets from one place"],
  ...
  },
  {
    ...
    tags: ["Route optimisation", "Demand prediction", "Dispatch agents", "Pricing engines"],
    outcomes: ["Adjust routes to live conditions", "Predict demand before it arrives", "Place vehicles where they are needed"],
