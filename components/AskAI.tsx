...
//
// Logos are the official single-color brand marks (source: simple-icons), drawn
// in currentColor so they sit in the footer's restrained palette rather than
// importing four clashing brand colors.
const ASK_PROMPT =
        ...
        {ENGINES.map((engine) => (
          <li key={engine.name}>
            <a
              ...
              className="inline-flex h-11 w-11 items-center justify-center text-[var(--fg)]/60 transition-colors hover:text-[var(--accent-text)]"
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
